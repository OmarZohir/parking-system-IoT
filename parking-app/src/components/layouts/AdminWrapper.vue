            ...
            <div class="px-2 flex items-center lg:px-0">
              ...
              <div class="hidden lg:block lg:ml-10">
                <div class="flex space-x-4">
                  ...
                  <router-link to="/admin" v-bind:class="{'bg-blue-700': route==='admin-home'}" class="text-white hover:bg-blue-500 hover:bg-opacity-75 rounded-md py-2 px-3 text-sm font-medium">
                    Overview
                  </router-link>
                  <router-link to="/admin/entries" v-bind:class="{'bg-blue-700': route==='entries'}" class="text-white hover:bg-blue-500 hover:bg-opacity-75 rounded-md py-2 px-3 text-sm font-medium">
                    Entries
                  </router-link>
...
<!--                        <div class="text-sm font-medium text-blue-300">tom@example.com</div>-->
        ...
        <div class="lg:hidden" v-bind:class="{'hidden': !menu.mobile, 'block': menu.mobile}">
          <div class="px-2 pt-2 pb-3 space-y-1">
            <router-link to="/admin" v-bind:class="{'bg-blue-700': route==='home'}" class="text-white hover:bg-blue-500 hover:bg-opacity-75 block rounded-md py-2 px-3 text-base font-medium">
              Overview
            </router-link>

            <router-link to="/admin/entries" v-bind:class="{'bg-blue-700': route==='entries'}" class="text-white hover:bg-blue-500 hover:bg-opacity-75 block rounded-md py-2 px-3 text-base font-medium">
              Entries
            </router-link>

            <router-link to="/make-reservation" v-bind:class="{'bg-blue-700': route==='create-reservation'}" class="text-white hover:bg-blue-500 hover:bg-opacity-75 block rounded-md py-2 px-3 text-base font-medium">
              Make a reservation
            </router-link>
          </div>
